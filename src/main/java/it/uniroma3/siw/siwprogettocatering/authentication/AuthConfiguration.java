package it.uniroma3.siw.siwprogettocatering.authentication;

import static it.uniroma3.siw.siwprogettocatering.authentication.model.Credentials.ADMIN_ROLE;
...
//import static it.uniroma3.siwprogettocatering.authentication.model.Credentials.DEFAULT_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/login/**", "/register", "/buffets/**", "/chefs/**", "/piatti/**", "/css/**", "/images/**", "/foto/**").permitAll()
